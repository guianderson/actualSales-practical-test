...
<head>
    ...
    <title>Guilherme Anderson - practical test</title>
		...
		<div class="top-area">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6 col-md-6">
					<p class="bold text-right">Call us now +55 (12) 98704-5093</p>
					</div>
				</div>
			</div>
		</div>
        <div class="container navigation">
            ...
            <div class="navbar-header page-scroll">
                <a class="navbar-brand" href="index.php">
                    <center><img src="img/logo-color.png" alt="" width="250" height="40" /></center>
                </a>
            </div>

            
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="navbar-right mobile-hide">
					...
					<div class="col-lg-6">
						...
						<div class="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.2s">
							...
							<div class="panel-heading">
									...
									<form role="form" action= "<?php echo $_SERVER['PHP_SELF']; ?>"  method="GET" class="lead">
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Full Name</label>
													<input type="text" required="required" name="name" id="name" class="form-control input-md">
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Date of Birth</label>
													<input type="date" required="required" name="birth" id="birth" class="form-control input-md">
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Email</label>
													<input type="email" required="required" name="email" id="email" class="form-control input-md">
												</div>
											</div>
											<div class="col-xs-6 col-sm-6 col-md-6">
												<div class="form-group">
													<label>Phone number</label>
													<input type="text" required="required" name="phone" id="phone" class="form-control input-md">
												</div>
											</div>
										</div>
										
										<?php 
											if(isset($_GET['name']) and isset($_GET['birth']) and isset($_GET['email']) and isset($_GET['phone'])){
												echo "<script>alert('Thanks ".$_GET['name']." for registering! Soon we will contact you by ".$_GET['email']." with more information.');
									                            window.location.replace('index.php');
									                  </script>";
											}
										?>

										<input class="btn btn-skin btn-block btn-lg" name="submit" type="submit" value="Get Offer Now" />
			...
			<div class="row">
				<div class="col-sm-6 col-md-4">
					...
					<div class="widget" style="color: #fff">
						<h5 style="color: #ff4200">About Medicio</h5>
						<p>
					...
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="widget">
						<h5 style="color: #ff4200">Information</h5>
						<ul>
							<li><a href="#"  style="color: #fff">Home</a></li>
							<li><a href="#"  style="color: #fff">Laboratory</a></li>
							<li><a href="#"  style="color: #fff">Medical treatment</a></li>
				...
				<div class="col-sm-6 col-md-4">
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="widget" style="color: #fff">
						<h5 style="color: #ff4200">Medicio center</h5>
						<p>
						Nam leo lorem, tincidunt id risus ut, ornare tincidunt naqunc sit amet.
						</p>
						<ul>
							<li>
								<span class="fa-stack fa-lg" style="color: #ff4200">
							...
							<li>
								...
								</span> +55 (12) 98704-5093
							</li>
							<li>
								<span class="fa-stack fa-lg" style="color: #ff4200">
									<i class="fa fa-circle fa-stack-2x"></i>
									<i class="fa fa-envelope-o fa-stack-1x fa-inverse"></i>
								</span> guilherme.anderson34@outlook.com
							</li>
				...
				<div class="col-sm-6 col-md-4">
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="widget" style="color: #fff">
						<h5 style="color: #ff4200">Our location</h5>
						<p>Rua Luiz Marchetti, 78, Jd Portugal, São José dos Campos - SP</p>		
						
					</div>
					</div>
					<div class="wow fadeInDown" data-wow-delay="0.1s">
					<div class="widget">
						<h5 style="color: #ff4200">Follow us</h5>
						<ul class="company-social">
								<li class="social-facebook"><a href="https://www.facebook.com/guilherme.andernson"><i class="fa fa-facebook"></i></a></li>
								<li class="social-facebook"><a href="https://www.linkedin.com/in/guilherme-anderson/"><i class="fa fa-linkedin"></i></a></li>
						</ul>
					</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6">
					...
					<div class="text-left">
					<p>&copy;Copyright 2021 - Guilherme Anderson.</p>
					</div>
					</div>
				</div>
			</div>	
